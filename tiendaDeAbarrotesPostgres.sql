...
GRANT USAGE ON SCHEMA inventario,transaccion,empresa TO EMPLEADO
...
GRANT SELECT ON ALL TABLES IN SCHEMA "empresa" TO EMPLEADO;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA "empresa" TO EMPLEADO;

--CLIENTE--
GRANT CONNECT ON DATABASE "tiendaAbarrotes" TO CLIENTE;
GRANT USAGE ON SCHEMA transaccion,inventario,empresa TO CLIENTE
...
GRANT SELECT ON ALL TABLES IN SCHEMA "empresa" TO CLIENTE;
GRANT SELECT ON ALL TABLES IN SCHEMA "inventario" TO CLIENTE;

GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA "inventario" TO CLIENTE;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA "transaccion" TO CLIENTE;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA "empresa" TO CLIENTE;
